...
export function useCheckinPage() {
  ...
  return {
    user, selectedTripId, setSelectedTripId, selectedTrip,
    showForm, setShowForm, editingCheckin, setEditingCheckin,
    sortOrder, setSortOrder, mounted, loading, displayError,
    trips, checkins, mapPhotos, mapCenter,
    tagline, taglineLoading, taglineError, refreshTagline,
    showDrawer, setShowDrawer, showTripForm, setShowTripForm,
    tripFormMode, setTripFormMode, editingTrip, setEditingTrip,
    deletingTripId, setDeletingTripId, applyingPlace,
    showLocationPicker, setShowLocationPicker,
    locationPickerInitial, locationPickerCallback, openLocationPicker,
    handleCheckinSuccess, handleDeleteCheckin, handleDeleteTrip,
    executeDeleteTrip, handleBulkApplyPlace, createTrip, updateTrip,
  };
}
